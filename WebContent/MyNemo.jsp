...
<div class="container">
 ...
 <%
	...
	try {
		...
		String sqlList ="SELECT * FROM enterUserToArticle AS UTA, Article AS AT WHERE UTA.userID=\"" + loginID + "\" AND UTA.articleID=AT.articleID AND  startDay > CURDATE()-1 ORDER BY AT.startDay DESC";
		// 내가 들어간 네모
